...
from oarepo_model_builder_drafts_files.datatypes.components.model import DraftFileRecordModelComponent
...
DRAFTS_FILES_COMPONENTS = [InvenioDraftsFilesComponent,  DraftFilesFieldModelComponent, DraftFileComponent, InvenioDraftsFilesRecordComponent,
                           DraftServiceExtComponent, DraftFilesModelTestComponent, DraftFilesFilesModelTestComponent, DraftFileRecordModelComponent]